...
public class GameRenderer {
    ...
    private void drawScore() {
        ...
        float fontX = world.gameWidth / 2 - AssetLoader.font.getBounds(world.getScore() + "").width / 2 + 5;
        float fontY = world.gameHeight / 2 + AssetLoader.font.getBounds(world.getScore() + "").height / 2 - 15;
